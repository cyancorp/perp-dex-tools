...
class HedgeBot:
    ...
    async def _send_iteration_summary(self, iteration_number: int):
        ...
        ext_size, ext_notional = self.extended_volume_base, self.extended_volume_notional
        light_size, light_notional = self.lighter_volume_base, self.lighter_volume_notional
